...
export default function Chatbot() {
  ...
  return (
    <div>
      ...
      {open && (
        <div className="fixed bottom-20 right-6 w-80 bg-[rgba(255,255,255,0.05)] backdrop-blur-sm border border-[#1F2937] shadow-2xl rounded-xl overflow-hidden z-50">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-4 font-semibold">
            AI Assistant
          </div>
          ...
          <div className="flex border-t border-[#1F2937]">
            <input
              ...
              className="flex-1 p-2 outline-none bg-transparent text-white placeholder-gray-500"
            />
            <button onClick={sendMessage} className="px-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
              Send
            </button>
          </div>
        </div>
